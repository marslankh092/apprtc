...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  private class ProxyVideoSink implements VideoSink {
    ...
    synchronized public void onFrame(VideoFrame frame) {
      ...
      VideoFrame.Buffer fmae = frame.getBuffer();
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    fullscreenRenderer.removeFrameListener(new EglRenderer.FrameListener() {
      @Override
  ...
  @Override
  public void onSpeakerSwitch() {
    audioManager.selectAudioDevice(!speaker ? AudioDevice.SPEAKER_PHONE : AudioDevice.EARPIECE );
  ...
  private void onConnectedToRoomInternal(final SignalingParameters params) {
    ...
    setup_timer();
    if(getIntent().getBooleanExtra(CallActivity.EXTRA_VIDEO_CALL,false)){
  ...
  void socketsetup() {
    ...
    try {
      ...
      mSocket.on("clearframe", new Emitter.Listener() {
        @Override
        public void call(Object... args) {
          ...
          if(fullscreenRenderer !=null) {
            ...
            if(!mSocket.id().equals(args[0])) {
              runOnUiThread(new Runnable() {
                @Override
                public void run() {
                  if(fullscreenRenderer.getVisibility() == View.GONE){
      ...
      mSocket.emit("begin_text_chat", 123);
