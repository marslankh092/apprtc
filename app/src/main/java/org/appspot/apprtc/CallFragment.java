...
import static org.appspot.apprtc.CallActivity.mSocket;
...
public class CallFragment extends Fragment {
  ...
  private ImageButton button_call_speaker;
  ...
  public View onCreateView(
    ...
    button_call_speaker = controlView.findViewById(R.id.button_call_speaker);
    ...
    button_call_speaker.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        callEvents.onSpeakerSwitch();
      }
    });
  ...
  public void onStart() {
    ...
    if (!videoCallEnabled) {
      ...
      button_call_speaker.setVisibility(View.VISIBLE);
    }else{
